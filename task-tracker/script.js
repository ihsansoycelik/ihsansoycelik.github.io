document.addEventListener('DOMContentLoaded', () => {
    ...
    function renderMainView() {
        ...
        tasks.forEach(task => {
            ...
            taskRow.innerHTML = `
                <div class="check-circle" role="checkbox" tabindex="0" aria-labelledby="task-text-${task.id}" aria-checked="${task.completed}"></div>
                <div class="task-content">
                    <input type="text" id="task-text-${task.id}" class="task-text" value="${escapeHtml(task.text)}" readonly>
